<?php 
  ...
  $sql = "SELECT * FROM `empresa_delivery` WHERE cidade LIKE '%$cidade%' OR nome_empresa LIKE '%$cidade%'
  OR seguimento LIKE '%$cidade%' OR descricao LIKE '%$cidade%' ORDER BY created DESC";
